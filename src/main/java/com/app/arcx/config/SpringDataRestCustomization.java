...
public class SpringDataRestCustomization implements RepositoryRestConfigurer {
    ...
    public void configureRepositoryRestConfiguration(RepositoryRestConfiguration config) {
        ...
        config.getCorsRegistry().addMapping("/**")
                .allowedOrigins("http://localhost:3000", "http://localhost:8080", "http://localhost:8082", "http://localhost:7000", "https://arcx-development-admin-ui.devsecops-eval.epa.gov", "http://arcx-development-admin-ui.devsecops-eval.epa.gov, https://arcx-public-ui-stg.devsecops-eval.epa.gov/").allowedMethods("*");
