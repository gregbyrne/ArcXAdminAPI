...
INSERT INTO data.user(email, enabled, password, username) VALUES('Powell.Joshua@epa.gov', true, '$2y$12$IE6hwy7.1PYm4gRCXRJigencdZrEI9sfFayV5ufybc.AzJr7i.3kG', 'tester');

INSERT INTO data.authority(name) VALUES('ROLE_ADMIN');
